...
/obj/machinery/suit_storage_unit/hev
	name = "Hazardous Voidsuit Storage Unit"
	suit= /obj/item/clothing/suit/space/void/excavation/thekekman666
	helmet = /obj/item/clothing/head/helmet/space/void/excavation/thekekman666
	boots = /obj/item/clothing/shoes/magboots
	tank = /obj/item/tank/oxygen
	mask = /obj/item/clothing/mask/breath
