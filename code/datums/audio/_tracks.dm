...
/decl/audio/track/necroos
	source = 'sound/music/crazynecroos.ogg'
	title = "Crazy Necroos"
	author = "Andrey Kuzmin and Victor Krasnokutskiy"

/decl/audio/track/hacker
	source = 'sound/music/hacker.ogg'
	title = "The Hacker"
	author = "Unknown Composer (From Systemshock 2 Fan missions)"

/decl/audio/track/dwarfs
	source = 'sound/music/dwarfs.ogg'
	title = "DF - Intro"
	author = "Tarn Adams"

/decl/audio/track/pathologic
